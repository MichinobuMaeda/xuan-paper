 ...
 * @property {string} brightness - Theme brightness mode ("light" or "dark")
 * @property {Array<ColorPair>} colors - Array of color token pairs
 */
 ...
 *   - Array of {brightness, colors} objects
 *   - brightness: "light" or "dark"
 *   - colors: Array of [tokenName, hexColor] pairs
 * @returns {Array<Array<string>>} Flat array of [cssVariableName, hexColor] pairs
 * @example
